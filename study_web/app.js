(() => {
  ...
  if (!packEntries.length) {
    throw new Error('PK_PACKS tidak ditemukan.');
  }

  const HISTORY_KEY = 'pk-session-history-v2';
  const ACTIVE_KEY = 'pk-active-session-v2';
  const ACTIVE_VERSION = 'usability-day2-v2';
